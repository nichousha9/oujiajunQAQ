...
export default class GlobalHeader extends PureComponent {
  ...
  render() {
    const {
      currentUser, collapsed, fetchingNotices, isMobile, logo, onNoticeVisibleChange, onMenuClick, onNoticeClear, owner
    } = this.props;
   // const ower = getCurrentOwer() || {};
    ...
    return (
      <div className={styles.header} style={{width: collapsed? 'calc(100% - 80px)': 'calc(100% - 180px)'}}>
{/*        {isMobile && [
